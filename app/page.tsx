...
const pricingPackages = [
  {
    ...
    credits: 40,
    price: 0,
    features: ["Standart kalite", "40 kredi", "Temel özellikler"],
    isPopular: false,
    isFree: true,
  },
  {
    ...
    credits: 100,
    price: 99,
    features: ["Tüm kaliteler", "100 kredi/ay", "Öncelikli destek", "Hızlı üretim"],
    isPopular: false,
    isFree: false,
  },
  {
    ...
    price: 199,
    originalPrice: 249,
    features: ["Tüm kaliteler", "250 kredi/ay", "VIP destek", "%20 tasarruf", "Öncelikli sıra"],
    isPopular: true,
    isFree: false,
  },
  {
    ...
    price: 399,
    originalPrice: 599,
    features: ["Tüm kaliteler", "600 kredi/ay", "Özel destek", "%33 tasarruf", "Öncelikli sıra", "Erken özellik erişimi"],
    isPopular: false,
    isFree: false,
  },
]
